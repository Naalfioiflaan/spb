...
class Berita(models.Model):
    ...
    topik = models.CharField(max_length=255, blank=True, null=True)
...
class BeritaGoriau(models.Model):
    judul = models.CharField(max_length=200, blank=True, null=True)
    link = models.CharField(max_length=500, blank=True, null=True)
    topik = models.CharField(max_length=255, blank=True, null=True)
    tanggal = models.DateField(blank=True, null=True)
    ...
    class Meta:
        managed = False
        db_table = 'berita_goriau'


class BeritaHaluanRiau(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'berita_haluan_riau'


class BeritaTribunPekanbaru(models.Model):
    judul = models.CharField(max_length=200, blank=True, null=True)
    link = models.CharField(max_length=500, blank=True, null=True)
    topik = models.CharField(max_length=255, blank=True, null=True)
    tanggal = models.DateField(blank=True, null=True)
    ...
    class Meta:
        managed = False
        db_table = 'berita_tribun_pekanbaru'
